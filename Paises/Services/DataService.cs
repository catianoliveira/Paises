...
namespace Paises.Services
{
    public class DataService
    {
        ...
        public void CreateDatabase()
        {
            ...
            try
            {
                ...
                string sqlcommand = "create table if not exists Countries " +
                    "(Alpha3Code varchar(2), Name varchar(50), Capital varchar(50), " +
                    "Region varchar(50), " +
        ...
        public void CreateTranslations()
        {
            ...
            try
            {
                ...
                string sqlcommand = "Create table if not exists translations " +
                    "(Alpha3Code varchar(2), De varchar(50), Es varchar(50)," +
        ...
        public void CreateLanguages()
        {
            ...
            try
            {
                ...
                string sqlcommand = "create table if not exists Languages " +
                    "(Alpha3Code varchar(2), LanguageName varchar(50)," +
        ...
        /// <summary>
        /// Gets data from the database when there's no internet connection
        /// </summary>
        /// <returns></returns>
        public async Task<List<Country>> GetData()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    {
                        Alpha3Code = GetDBStringValue(reader, 0),
                    ...
                    string sqlLanguages = "select LanguageName, NativeName from languages where alpha3code = @country";
                    ...
                    string sqlTranslations = "select De, Es, Fr, Ja, It, Br, Pt, Nl, Hr, Fa from translations where alpha3code = @country";
        ...
        /// <summary>
        /// Checks if entry from database is null
        /// </summary>
